  ...
  return (
    <>
      <SEO
        ...
        description="The page you're looking for doesn't exist. Return to The Treasured Tales homepage."
        url="https://thetreasuredtales.com/404"
        canonical="https://thetreasuredtales.com/404"
      />
